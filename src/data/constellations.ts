...
export const CLASS_CONSTELLATIONS: Record<ClassId, ClassConstellation> = {
  warrior: {
    ...
    branches: [
      ...
      chain('warrior', 'seisme', 'mst', 'Séisme', [
        ...
        { tier: 4, name: 'Cataclysme', desc: 'Fin de Parade : séisme gratuit (charge bloquée incluse).', icon: 'fa-meteor', cost: 1, keystone: true, effects: { atk: 8, skillMods: { space: 0.1 }, passive: 'parryCharge', passiveRank: 1 } },
      ]),
    ],
  },
  ...
  sentinel: {
    ...
    branches: [
      chain('sentinel', 'rayon', 'atk', 'Rayon', [
        ...
        { tier: 4, name: 'Supernova', desc: 'Passif : Rayon Stellaire +10 % taille, scaling 5 % PV max', icon: 'fa-star', cost: 1, keystone: true, effects: { atk: 8, crit: 0.08, passive: 'solarBeamHaste', passiveRank: 1 } },
      ]),
  ...
  blade: {
    ...
    apex: {
      ...
      tier: 5,
      name: 'Soif Éternelle',
      desc: '+0,3 % crit et dégâts crit par % PV manquant.',
      icon: 'fa-skull',
      cost: 2,
      keystone: true,
  ...
  pacifier: {
    ...
    apex: {
      ...
      tier: 5,
      name: 'Pacte de Sang',
      desc: '+45 % dégâts crit · Méga-Crit tous les 3 tirs.',
      icon: 'fa-heart-pulse',
      cost: 2,
      keystone: true,

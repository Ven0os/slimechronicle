...
export const CLASS_CONSTELLATIONS: Record<ClassId, ClassConstellation> = {
  warrior: {
    ...
    apex: {
      ...
      desc: 'Peau de Fer amplifiée : -18% dégâts reçus. La Parade stocke 40% des dégâts bloqués pour la prochaine Frappe Sismique.',
      icon: 'fa-crown',
      cost: 2,
      keystone: true,
    ...
    branches: [
      chain('warrior', 'rempart', 'hp', 'Rempart', [
        ...
        { tier: 4, name: 'Mur Impénétrable', desc: 'Passif : réduction des dégâts + renfort défensif', icon: 'fa-fort-awesome', cost: 1, keystone: true, effects: { maxHpPct: 0.15, regen: 1, passive: 'ironWall', passiveRank: 1 } },
      ]),
      chain('warrior', 'fureur', 'atk', 'Fureur', [
        ...
        { tier: 4, name: 'Titan Sanguin', desc: 'Passif : ATK bonus selon vos PV max', icon: 'fa-dumbbell', cost: 1, keystone: true, effects: { passive: 'titanBlood', passiveRank: 1 } },
      ]),
      chain('warrior', 'cri', 'spd', 'Cri', [
        ...
        { tier: 4, name: 'Parade Réactive', desc: 'Passif : Parade réduit les temps de recharge', icon: 'fa-shield-virus', cost: 1, keystone: true, effects: { passive: 'parryRefund', passiveRank: 1 } },
      ]),
      chain('warrior', 'seisme', 'mst', 'Séisme', [
        ...
        { tier: 4, name: 'Cataclysme', desc: 'Passif : Parade charge la Frappe Sismique', icon: 'fa-meteor', cost: 1, keystone: true, effects: { atk: 8, skillMods: { space: 0.1 }, passive: 'parryCharge', passiveRank: 1 } },
      ]),
    ],
  },
  ...
  sentinel: {
    ...
    apex: {
      ...
      tier: 5,
      name: 'Hélios Incarné',
      desc: 'Aura Solaire : +15% ATK et soin de 1% PV/s aux alliés proches (solo : sur vous).',
      icon: 'fa-sun',
      cost: 2,
      keystone: true,
  ...
  pacifier: {
    ...
    branches: [
      ...
      chain('pacifier', 'rituel', 'mst', 'Rituel', [
        ...
        { tier: 4, name: 'Hémoglobine', desc: 'Passif : Saut Vampirique renforcé + vol de vie', icon: 'fa-vial', cost: 1, keystone: true, effects: { lifesteal: 0.03, passive: 'vampJumpAmp', passiveRank: 1 } },
      ]),
    ],
  },

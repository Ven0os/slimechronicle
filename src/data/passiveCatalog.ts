...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  titanBlood: { key: 'titanBlood', name: 'Sang de Titan', desc: '2% des PV max convertis en DEF bonus (scaling runique).', icon: 'fa-dumbbell', color: '#c0392b', category: 'defense' },
  ...
  runicColossus: { key: 'runicColossus', name: 'Colosse Runique', desc: '−18% dégâts reçus. Parade stocke 40% des blocages pour le Séisme.', icon: 'fa-crown', color: '#d4af37', category: 'defense' },

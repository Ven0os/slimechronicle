...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  solarInspiration: { key: 'solarInspiration', name: 'Hélios Incarné', desc: 'Aura 14 m : alliés +15 % ATK et 1 % PV/s ; vous +30 % ATK (soin non doublé).', icon: 'fa-sun', color: '#ffcc00', category: 'synergy' },

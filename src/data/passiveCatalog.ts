...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  bloodPact: { key: 'bloodPact', name: 'Hémocycle', desc: 'Blood Pistol applique des Marques de Sang. Chaque marque stocke des dégâts amplifiés par les HP max du personnage.', icon: 'fa-heart-pulse', color: '#ff4d6d', category: 'synergy' },

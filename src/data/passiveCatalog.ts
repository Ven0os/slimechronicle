...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  solarBeamHaste: { key: 'solarBeamHaste', name: 'Faisceau Dévastateur', desc: 'Rayon Stellaire +10 % taille, scaling 5 % PV max, impact renforcé.', icon: 'fa-sun', color: '#f1c40f', category: 'offense' },
  ...
  solarInspiration: { key: 'solarInspiration', name: 'Hélios Incarné', desc: 'Aura 14 m : alliés +15 % ATK et 1 % PV/s ; vous +30 % ATK. Champ de Lumière : malus ennemis renforcé.', icon: 'fa-sun', color: '#ffcc00', category: 'synergy' },

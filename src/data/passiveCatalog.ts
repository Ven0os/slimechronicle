...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  solarInspiration: { key: 'solarInspiration', name: 'Singularité Stellaire', desc: 'Rayon Stellaire crée des Puits de Lumière sur kill. Alliés : +15 % ATK. Sentinel : +30 % ATK.', icon: 'fa-sun', color: '#ffcc00', category: 'synergy' },

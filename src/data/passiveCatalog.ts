...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  eternalThirst: { key: 'eternalThirst', name: 'Soif Éternelle', desc: '+0,3 % crit et dégâts crit par % PV manquant.', icon: 'fa-skull', color: '#922b21', category: 'synergy' },
  ...
  continuumMastery: { key: 'continuumMastery', name: 'Architecte de la Fracture', desc: '3 prismes · Fracture 150 % · +0,33 % dmg/Fracture.', icon: 'fa-infinity', color: '#ffd93d', category: 'synergy' },
};

...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  ruptureAstrale: { key: 'ruptureAstrale', name: 'Rupture Astrale', desc: 'Tous les 4 coups de lance : Rupture Astrale (80 % dégâts, effets Soleil/Lune). Sous Cataclysme : +50 %.', icon: 'fa-burst', color: '#9b59b6', category: 'offense' },
  ...
  celestialConvergence: { key: 'celestialConvergence', name: 'Convergence Éclipsée', desc: 'Rupture Astrale : −0,5 s Pic de Lune par ennemi. Sous Cataclysme : Fragilité Lunaire (+10 % dégâts lance).', icon: 'fa-circle-half-stroke', color: '#af7ac5', category: 'synergy' },

...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  stellarOvercharge: { key: 'stellarOvercharge', name: 'Surcharge Stellaire', desc: 'Rayon Stellaire : charge maximale portée à 250 %. Les dégâts continuent d\'augmenter après la charge normale. Relâcher : tire avec la charge actuelle.', icon: 'fa-star', color: '#f1c40f', category: 'offense' },
  ...
  extraPrismLens: { key: 'extraPrismLens', name: 'Prisme Supplémentaire', desc: 'Les Lentilles génèrent 4 rayons au lieu de 3. Dégâts des rayons : −15 % mais inflige brûlure.', icon: 'fa-gem', color: '#48c9b0', category: 'offense' },

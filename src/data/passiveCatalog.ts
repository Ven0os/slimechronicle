...
export const PASSIVE_CATALOG: Record<string, PassiveDisplayMeta> = {
  ...
  ironWall: { key: 'ironWall', name: 'Mur Impénétrable', desc: 'Réduction passive des dégâts physiques reçus.', icon: 'fa-shield-halved', color: '#7f8c8d', category: 'defense' },
  warFervor: { key: 'warFervor', name: 'Ferveur Guerrière', desc: 'Les attaques accumulent des stacks augmentant l\'ATK.', icon: 'fa-fire', color: '#e74c3c', category: 'offense' },
  titanBlood: { key: 'titanBlood', name: 'Sang de Titan', desc: 'Bonus d\'ATK proportionnel aux PV maximum.', icon: 'fa-dumbbell', color: '#c0392b', category: 'offense' },
  warCryAmp: { key: 'warCryAmp', name: 'Cri Amplifié', desc: 'Le Cri de Guerre soigne et repousse davantage.', icon: 'fa-bullhorn', color: '#f39c12', category: 'utility' },
  parryRefund: { key: 'parryRefund', name: 'Parade Réactive', desc: 'La Parade réduit les temps de recharge.', icon: 'fa-shield-virus', color: '#9b59b6', category: 'utility' },
  parryCharge: { key: 'parryCharge', name: 'Charge Sismique', desc: 'La Parade charge la prochaine Frappe Sismique.', icon: 'fa-mountain', color: '#8e44ad', category: 'synergy' },
  runicColossus: { key: 'runicColossus', name: 'Colosse Runique', desc: 'Peau de Fer supérieure + stockage de blocage.', icon: 'fa-crown', color: '#d4af37', category: 'defense' },
  ...
  paradoxOverload: { key: 'paradoxOverload', name: 'Paradoxe Absolu', desc: 'Surcharge maximale sur tous les sorts.', icon: 'fa-infinity', color: '#2980b9', category: 'synergy' },
  ...
  solarBeamHaste: { key: 'solarBeamHaste', name: 'Faisceau Accéléré', desc: 'Rayon Stellaire charge plus vite.', icon: 'fa-sun', color: '#f1c40f', category: 'offense' },
  ...
  solarInspiration: { key: 'solarInspiration', name: 'Hélios Incarné', desc: 'Aura inspirante : régénération et bonus offensif.', icon: 'fa-sun', color: '#ffcc00', category: 'synergy' },
  ...
  eternalThirst: { key: 'eternalThirst', name: 'Soif Éternelle', desc: 'Bonus de dégâts à bas PV maximisé.', icon: 'fa-skull', color: '#922b21', category: 'synergy' },
  ...
  vampJumpAmp: { key: 'vampJumpAmp', name: 'Saut Vampirique+', desc: 'Zone d\'étourdissement élargie.', icon: 'fa-arrow-up', color: '#922b21', category: 'utility' },
  bloodPact: { key: 'bloodPact', name: 'Pacte de Sang', desc: 'Bouclier et Frénésie au potentiel maximal.', icon: 'fa-heart-pulse', color: '#ff0066', category: 'synergy' },
  ...
  celestialConvergence: { key: 'celestialConvergence', name: 'Convergence', desc: 'Ascension permanente après cycle astral.', icon: 'fa-circle-half-stroke', color: '#af7ac5', category: 'synergy' },
  ...
  continuumMastery: { key: 'continuumMastery', name: 'Architecte de la Fracture', desc: 'Ascendant +60%. Fenêtre Écho 80-98%. Surchauffe -25% contrecoup.', icon: 'fa-infinity', color: '#ffd93d', category: 'synergy' },
};
